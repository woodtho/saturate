...
#' @param return_by Character. Requested return date for the participant's
#'   response (free text, e.g. `"2025-03-01"`).
#' @param return_to Character. Contact name or address to return feedback to.
#' @param return_instructions Character. Instructions for how the participant
#'   should return their response.
#' @param notes Character. Internal notes about this member check.
#'
