...
[DuckDB](https://duckdb.org/) — one portable `.duckdb` file per project
— with an interactive Shiny GUI for text coding, codebook management,
and multi-coder collaboration.
